@extends('layouts.main', ['activePage' => 'users' , 'titlePage' =>'Detalles del usuario o fundación'])
@section('content')
<div class="content">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Usuarios o fundaciones</h4>
                                <p class="card-category">Vista dellada del usuario o fundación {{$user->nombre_usuario}}</p>
                            </div>
