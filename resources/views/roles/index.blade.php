                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @empty
                          <span class="badge badge-danger">No se ha asignado ningún permiso</span>
                      @endforelse
                    </td>
                    ...
                    @can('eliminar_rol')
                      <form action="{{ route('roles.destroy', $role->id) }}" method="post"
                        onsubmit="return confirm('Esta seguro de eliminar este rol')" style="display: inline-block;">
                        @csrf
                        @method('DELETE')
